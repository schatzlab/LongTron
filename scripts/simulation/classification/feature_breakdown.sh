...
#recurrent problems
~/filter_one_file_by_another.py -f ${NOVELS} -t all.3.trans.names -w -c 0 -n > all.3.trans.names.nonovels
...
~/filter_one_file_by_another.py -f all.problem.names.sorted.u -t ../gencode.v28.basic.annotation.transcripts_exon_count -w -c 0 -n | cut -f 1 > good_tnames
~/filter_one_file_by_another.py -f ${NOVELS} -t good_tnames -w -c 0 -n > good_tnames.nonovels
...
~/filter_one_file_by_another.py -f ${NOVELS} -t all.problem.names.sorted.u.nonall3 -w -c 0 -n > all.problem.names.sorted.u.nonall3.nonovels
